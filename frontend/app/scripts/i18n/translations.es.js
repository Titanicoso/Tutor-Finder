...
define([], function() {
	...
	return {
		...
		FILTER_TIME: 'Filtrar por dia y hora',
		FILTER_MAX: 'Máximo',
		FILTER_MIN: 'Mínimo',
		...
		ERROR_ADDING_TIMESLOT: 'Ocurrió un error al intentar agregar el horario',
		ERROR_DELETING_TIMESLOT: 'Ocurrió un error al intentar borrar el horario',
